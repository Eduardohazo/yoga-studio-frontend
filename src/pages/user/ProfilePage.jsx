...
const ProfilePage = () => {
 ...
 return (
 <PageWrapper>
 <h1 className="font-serif text-3xl font-bold text-gray-800 mb-8">My Profile</h1>
 ...
 <Input label="Phone" name="phone" value={form.phone} onChange={handle} placeholder="+52 33..." />
 <Input label="Avatar URL" name="avatar" value={form.avatar} onChange={handle} placeholder="https://..." />
