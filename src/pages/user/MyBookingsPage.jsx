...
const MyBookingsPage = () => {
 ...
 return (
 <PageWrapper>
 <h1 className="font-serif text-3xl font-bold text-gray-800 mb-6">My Bookings</h1>
 ...
 {shown.length ? shown.map((b) => <BookingCard key={b._id} booking={b} onCancelled={fetchBookings} />) : (
