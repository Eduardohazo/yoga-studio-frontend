  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4 flex-wrap">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              {schedules.length} sessions total
            </p>
          </div>
          <Button className="w-full md:w-auto" onClick={openNew}>
            + New Session
          </Button>
        </div>
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        <span
                          className={`font-medium ${s.enrolled >= s.capacity ? "text-red-600" : "text-gray-600"}`}
                        >
                          {s.enrolled}
                        </span>
                    ...
                    <td className="px-4 py-3">
                      <Badge label={s.status} variant={statusColor[s.status]} />
                    </td>
                    <td className="px-4 py-3">
        ...
        {/* Modals remain unchanged but grid forms now responsive */}
        {/* Create/Edit Modal */}
        <Modal
          isOpen={showModal}
          ...
          <div className="space-y-4">
            <div className="p-4 bg-red-50 rounded-xl border border-red-100">
              <p className="font-medium text-gray-800">
                {cancelModal?.class?.title}
              </p>
              <p className="text-sm text-gray-500 mt-1">
                {cancelModal?.date ? formatDate(cancelModal.date) : ""} ·{" "}
                {cancelModal?.startTime}
              </p>
              <p className="text-sm text-gray-500">
                {cancelModal?.enrolled} student(s) enrolled — they will be
                notified by email
              </p>
            </div>
            <div>
            ...
            <div className="flex gap-3">
              ...
              <Button
                ...
                className="flex-1"
              >
                Cancel Session & Notify Students
              </Button>
            </div>
          </div>
        </Modal>
