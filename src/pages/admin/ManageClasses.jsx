              ...
              <tbody className="divide-y divide-gray-50">
                {filtered.map((c) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Badge label={c.level} variant={levelColor[c.level]} />
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full font-medium ${c.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-600"}`}
                      >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                ...
                <input
                  ...
                  onChange={h}
                  className={S}
                  placeholder="morning, flow, stretch"
                />
              </div>
            </div>
        ...
        >
          <div className="text-center py-4">
            ...
            <p className="text-gray-700 font-medium mb-1">
              Delete{" "}
              <span className="text-primary">"{deleteModal?.title}"</span>?
            </p>
            <p className="text-gray-500 text-sm mb-6">
              This will deactivate the class. Existing bookings are not
              affected.
            </p>
